...
public class splash extends Activity{
    ...
    // Array of String to Show In TextSwitcher
        String[] textToShow={"Born Nicolas Coppola, he chose Cage as his stage name to honor comic book superhero Luke Cage.",   
        		"Inspired by Superman's birth name, Cage christened his (now 5-year-old) son Kal-El.",   
        		...
        		"Cage’s second movie role was selling popcorn at a movie theater.",   
        		"But in 1983, Cage made a name for himself with the cult comedy 'Valley Girl' and his uncle Francis Ford Coppola's 'Rumble Fish,' and he never looked back.",   
        		...
        		"Nic's first wife decided to test his dedication by giving him a list of seemingly impossible tasks that he'd need to perform before she'd accept including procuring the autograph of reclusive author J.D. Salinger -- which he improbably managed.",   
        		"It still took eight years for Cage to convince his first wife to marry him, which they finally did in 1995. The couple separated after nine months -- although they did not divorce until 2000.",  
        		...
        		"Nic has admitted to taking hallucinogenic mushrooms with his cat on at least one occasion. Seeing that the cat, Lewis, had snuck into the refrigerator and eaten the 'shrooms 'voraciously,' Cage reasoned, 'What the heck, I better do it with him.'",  
        		"Cage was appointed a goodwill ambassador for the U.N. Office on Drugs and Crime in 2009.",   "He once donated 2 million dollars to Amnesty International to aid former child soldiers.",  
        		...
        		"Cage once woke up with a naked man eating a fudgsicle at the end of his bed",
        		"In 1996, Nic was cast as Superman",
        		"Nic Cage has appeared in over 75 movies",
        		"Cage is fascinated by ley lines, defined as 'alignments of ancient sites or holy places, such as stone circles, standing stones, cairns and churches.'",  
        		...
        		"Nic bought a Bahamanian island in 2006, near the one owned by Faith Hill and Tim McGraw. He also bought a German castle that year. He was forced to sell both in 2009, when his wild spending sprees caught up to him.",   
        		...
        		"When filming 'Bad Lieutenant: Port of Call New Orleans' in the Big Easy, Cage bought a two-headed snake for protection. Later, he donated it to a zoo.", 
        		...
        		"Nic said in 2010 'I actually choose the way I eat according to the way animals have sex. I think fish are very dignified with sex. So are birds. But pigs, not so much. So I don't eat pig meat or things like that. I eat fish and fowl.'",   
        		"Cage has done ads for Montblanc watches and Sankyo pachinko machines.",   
        		"Cage paid $276,000 at auction for a dinosaur skull of a Tarbosaurus; one of the people he outbid was Leonardo DiCaprio.",   
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
              ...
              ImageButton continuebutton = (ImageButton) findViewById(R.id.imageButton1);
